...
module.exports = {
	"phone/send" : function(req, res){
		...
		Accounts.findOne({phone:data.phone}).exec(function(err,found){
			...
			var request = r.post({
				url : 'https://api.authy.com/protected/json/phones/verification/start?api_key=JTPtfmOKep0j5Z5Rnt70y1wXT8DeE6WL', 
				headers : {"Content-Type":"application/x-www-form-urlencoded"},
				form : {  phone_number : data.phone, country_code : 1, via : 'sms'  }
